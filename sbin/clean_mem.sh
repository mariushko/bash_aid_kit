...
declare -l mem_total_human=$(k2h ${mem_total})
declare -l swap_total_human=$(k2h ${swap_total})
...
declare -l before_used_mem_human=$(k2h $(( mem_total - before_mem_free )))
declare -l before_used_swap_human=$(k2h $(( swap_total - before_swap_free )))
...
declare -l after_used_mem_human=$(k2h $(( mem_total - after_mem_free )))
declare -l after_used_swap_human=$(k2h $(( swap_total - after_swap_free )))
declare -l recovered_mem_human=$(k2h $(( after_mem_free - before_mem_free )))
declare -l recovered_swap_human=$(k2h $(( after_swap_free - before_swap_free )))
echo after:
